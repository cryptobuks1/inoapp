                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-5 col-lg-4">
                                <div class="form-element margin-bottom-20">
                                    <label class="d-block">First Name : {{$user->fname}}</label>
                                    <label class="d-block">Last Name : {{$user->lname}}</label>
                                    <label class="d-block">Email : {{$user->email}}</label>
                                    <label class="d-block">Contact No : {{$user->phone}}</label>
                                    <label class="d-block">Country : {{$user->country->name}}</label>
                                </div>
                            </div>
                            <div class="col-md-5 col-lg-4">
                                <div class="form-element margin-bottom-20">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="btn-wrapper">
                                    <input type="submit" class="cmn-btn" value=" Update Profile">
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
