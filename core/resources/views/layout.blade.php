    ...
    <div class="container nav-container">
        <div class="logo-wrapper navbar-brand">
            <a href="{{route('main')}}" class="logo main-logo">
                <img src="{{asset('assets/images/logo/logo.png')}}" alt="logo" style="max-width: 180px;" class="max-logo-height">
            </a>
        </div>
        <div class="collapse navbar-collapse" id="mirex">
            ...
            <ul class="navbar-nav">
                ...
                @endif
                <li class="d-md-none">
                    <a href="{{route('login')}}" class="boxed-btn btn-rounded m-2">Login</a>
                </li>
                <li class="d-md-none">
                    <a href="{{route('register')}}" class="boxed-btn btn-rounded m-2">Register</a>
                </li>
            </ul>
            <!-- /.navbar-nav -->
        </div>
