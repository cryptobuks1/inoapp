...
@section('content')
    ...
    <div class="blog-details-page-conent">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="single-blog-details-post single-blog-details-inner-wrapper"><!-- single blog page -->
                        <div class="thumb">
                            <img src="{{asset('assets/images/post/'.$post->image)}}" class="w-100" alt="{{$post->title}}">
                        </div>
                        <div class="content">
